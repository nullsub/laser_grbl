...
NO_OP = arch/stm32l/stm32/Libraries/CMSIS/CM3/CoreSupport/core_cm3.c #buggy toolchain breaks if this file is optimized!
# Compile: create object files from C source files.
define COMPILE_C_SOURCE
$(OUTDIR)/$(notdir $(basename $(1))).o : $(1)
##	@echo
	@echo "**** Compiling :" $$< "->" $$@
	@if [ "$$<" = $(NO_OP) ]; then echo "No optimization" && $(CC) -c $$(CFLAGS) -O0 $$< -o $$@; else $(CC) -c $$(CFLAGS) $$< -o $$@; fi
endef
